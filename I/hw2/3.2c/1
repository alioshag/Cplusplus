//H3.2b Definition of an operator< friend for a class date with the three private, non-static data members.
//H3.2c Definition of an operator! public const member function (it must be a member function to be able to access
//       the private data member of its class. It doesn't need to be a friend funct since the ! operator is unary.
...
//H3.2c Added by AG
        const bool operator!() {date d = *this; return d.month<january || d.month>december ||
                d.day<1 || d.day>length[d.month];}
...
//inline bool operator!=(const date& d) {return !(!d);}   //Added by AG
