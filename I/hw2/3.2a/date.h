...
class date {
	int day;              //number of days before or after Jan 1, 0 AD
...
//	bool operator==(const date& another) const {return day == another.day;}
	...
	friend int  operator- (const date& d1, const date& d2){return d1.day-d2.day;}
        friend bool operator< (const date& d1, const date& d2){return d1.day<d2.day;}//************** Added by AG-H3.2
...
inline bool operator>=(const date& d1, const date& d2) {return !(d1<d2);} //*********Added by AG H3.2
inline bool operator> (const date& d1, const date& d2) {return (d2<d1);}  //*********Added by AG H3.2
inline bool operator<=(const date& d1, const date& d2) {return (d2>=d1);}  //*********Added by AG H3.2
