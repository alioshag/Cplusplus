...
int main()
{
	...
	*/
	...
	const string predicate[] = {
		...
		"grow(s) 50 times in size and goe(s) on a destructive rampage",
		...
		"command(s) a fleet of starships "
			"against a horde of insectoid aliens",
	...
	cout << subject[rand() % nsubject] << "\n"
		<< predicate[rand() % npredicate] << "\n"
