...
int main()
{
	...
	*/
	//bool missing[n] = {true, true, true, true, true, true, true, true, true};
        ...
        for (size_t row = 0; row < n; ++row) {
	        bool missing[n] =
		      {true, true, true, true, true, true, true, true, true};
                size_t count = n;          //values missing per row
                for (size_t col = 0; col < n; ++col) {
                        const int value = a[row][col];
                        
                        if (value == x) {
                                empty_place = col;      //Found an empty place.i
